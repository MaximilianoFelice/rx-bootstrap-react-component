...
var InputField = exports.InputField = function (_RxReact$Component) {
  ...
  function InputField(props) {
    ...
    _this.state = { labelText: _this.props.labelText };
    return _this;
  }
  ...
  _createClass(InputField, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_label2.default, { text: this.state.labelText }),
        _react2.default.createElement(Input, (0, _helpers.without)("labelText", Object.assign({}, this.props, this.state)))
      );
    }
  }]);
