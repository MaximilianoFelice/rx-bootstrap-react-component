...
var InputField = exports.InputField = function (_BaseComponent) {
  ...
  function InputField(props) {
    ...
    _this.childrenObservable = _this.parentSubject.merge(_this.props.observeOn);

    _this.labelObs = _this.childrenObservable.map(function (x) {
      return { data: x.data.labelProps };
    });
    _this.inputObs = _this.childrenObservable.map(function (x) {
      return { data: x.data.inputProps };
    });
    _this.errorsObs = _this.childrenObservable.map(function (x) {
