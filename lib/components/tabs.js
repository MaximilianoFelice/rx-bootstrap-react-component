...
var Tab = exports.Tab = function (_BaseComponent) {
  ...
  _createClass(Tab, [{
    ...
    value: function componentWillMount() {
      ...
      _get(Object.getPrototypeOf(Tab.prototype), 'componentWillMount', this).call(this);

      this.props.observerErrorsOn.subscribe(function (x) {
        return _this2.setState({ errors: !(x === undefined || x === null) });
      });
    }
  }, {
    key: 'errorClassName',
...
var Tabs = exports.Tabs = function (_BaseComponent2) {
  ...
  function Tabs(props) {
    ...
    var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(Tabs).call(this, props));

    _this3.state.tabs = _this3.props.children;

    _this3.state.activeTab = _this3.state.tabs.find(function (c) {
      return c.props.active;
    }) || _this3.state.tabs[0];

    if (_this3.props.observeTransitionsOn) {
      _this3.props.observeTransitionsOn.filter(function (e) {
        return e.name === "previousTab";
      }).subscribe(function (_) {
        return _this3.moveTabBackwards();
      });

      _this3.props.observeTransitionsOn.filter(function (e) {
        return e.name === "nextTab";
      }).subscribe(function (_) {
        return _this3.moveTabForwards();
      });
    }
    return _this3;
  }
  ...
  _createClass(Tabs, [{
    ...
    value: function _moveTab(units) {
      ...
      var activeIndex = this.state.tabs.findIndex(function (tab) {
        return tab === _this4.state.activeTab;
      });
    ...
    value: function _renderNav() {
      ...
      return _react2.default.createElement(
        ...
        this.state.tabs.map(function (t, i) {
          return _this5._renderNavLink(t, i);
        })
      );
    }
  }, {
        ...
        _react2.default.createElement(
          'a',
          {
            onClick: function onClick(_) {
              return _this6.setState({ activeTab: tab });
            },
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.state.tabs.map(function (tab) {
            return _react2.default.cloneElement(tab, { active: tab == _this7.state.activeTab, key: tab.props.name });
          })
        )
      );
    }
