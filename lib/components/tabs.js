    ...
    value: function _renderNav() {
      ...
      return _react2.default.createElement(
        ...
        this.state.tabs.map(function (t, i) {
          return _this3._renderNavLink(t, i);
        })
      );
    }
  }, {
        ...
        _react2.default.createElement(
          'a',
          {
            onClick: function onClick(_) {
              return _this4.setState({ activeTab: tab });
            },
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.state.tabs.map(function (tab) {
            return _react2.default.cloneElement(tab, { active: tab == _this5.state.activeTab, key: tab.props.name });
          })
        )
      );
    }
